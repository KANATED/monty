 ...
 */
void print_to_stack(stack_t **stack, unsigned int line_number)
{
	stack_t *tmp;
 ...
 */
void pop_to_top(stack_t **stack, unsigned int line_number)
{
	stack_t *tmp;
 ...
 * @line_number: Interger representing the line number of of the opcode.
 */
void print_to_top(stack_t **stack, unsigned int line_number)
{
	if (stack == NULL || *stack == NULL)
